...
class _PersonalInformationScreenState extends State<PersonalInformationScreen> {
  final TextEditingController _firstNameController = TextEditingController(text: 'Thomas');
  final TextEditingController _lastNameController = TextEditingController(text: 'Thomas');
  final TextEditingController _emailController = TextEditingController(text: 'thomas@gmail.com');
